...
#define RACES_ALL_KINDS list(ALIZ_ALL_RACES, RACES_NOBILITY_ELIGIBLE, RACES_CHURCH_FAVORED, RACES_APPOINTED_OUTCASTS, RACES_MANMADE, RACES_SECOND_CLASS, RACES_FEARED, RACES_WIDELY_REVILED)
...
#define ALIZ_NOBLE_RACES_W_DWARF list(\
	/datum/species/human/northern,\
	/datum/species/elf/dark,\
	/datum/species/aasimar,\
)

#define ALIZ_ONLY_HUMAN list(\
	/datum/species/human/northern,\
)

#define ALIZ_ALL_RACES list(\
	/datum/species/human/northern,\
	/datum/species/elf/dark,\
	/datum/species/dwarf/mountain,\
	/datum/species/aasimar,\
...
//preference stuff
#define FAMILY_NONE "Нету"
#define FAMILY_PARTIAL "Братья/Сёстры"
#define FAMILY_NEWLYWED "Брак"
#define FAMILY_FULL "Полная"

#define ANY_GENDER "Любой"
#define SAME_GENDER "Одинаковый"
#define DIFFERENT_GENDER "Иной"
...
#define CTAG_TOWNER 		"CAT_TOWNER"
#define CTAG_PBLACKSMITH	"CTAG_PBLACKSMITH"  		// Villager class - Villagers can use it
...
#define CTAG_MARSHGEN		"CTAG_MARSHGEN"
#define CTAG_OJAN			"CTAG_OJAN"
#define CTAG_JAN			"CTAG_JAN"
#define CTAG_INS			"CTAG_INS"
#define CTAG_ACADEM			"CTAG_ACADEM"
