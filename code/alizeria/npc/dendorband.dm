...
/mob/living/carbon/human/species/human/northern/dendorbanditone
	aggressive=1
	rude = TRUE
	mode = NPC_AI_IDLE
...
/mob/living/carbon/human/species/human/northern/dendorbanditone/ambush
	aggressive = 1
	mode = NPC_AI_IDLE
	wander = FALSE

/mob/living/carbon/human/species/human/northern/dendorbanditone/retaliate(mob/living/L)
	var/newtarg = target
	.=..()
	if(target)
		aggressive=1
...
/mob/living/carbon/human/species/human/northern/dendorbanditone/should_target(mob/living/L)
	if(L.stat != CONSCIOUS)
		return FALSE
	. = ..()

/mob/living/carbon/human/species/human/northern/dendorbanditone/Initialize()
	. = ..()
...
/mob/living/carbon/human/species/human/northern/dendorbanditone/after_creation()
	..()
	job = "Highwayman"
	...
	equipOutfit(new /datum/outfit/job/human/species/human/northern/dendorbanditone)
...
/mob/living/carbon/human/species/human/northern/dendorbanditone/npc_idle()
...
/mob/living/carbon/human/species/human/northern/dendorbanditone/handle_combat()
	if(mode == NPC_AI_HUNT)
		if(prob(2)) // do not make this big or else they NEVER SHUT UP
			emote("laugh")
	. = ..()

/datum/outfit/job/human/species/human/northern/dendorbanditone/pre_equip(mob/living/carbon/human/H)
	...
	H.STASTR = rand(13,15) //GENDER EQUALITY!!
	H.STASPD = 12
