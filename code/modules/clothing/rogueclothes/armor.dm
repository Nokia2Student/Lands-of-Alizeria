...
/obj/item/clothing/suit/roguetown/armor/gambeson/heavy/town
	name = "royal gambeson"
	desc = "A fancy gambeson for royalty. Adorned with extra details and padded for extra protection."
	icon_state = "royalgamb"
	color = "#3a7a29"
...
/obj/item/clothing/suit/roguetown/armor/chainmail/blackkguard
	color = "#2b2b2b"
...
/obj/item/clothing/suit/roguetown/armor/aliz/brsheriff
	slot_flags = ITEM_SLOT_ARMOR
	name = "brigandine"
	desc = "Composite armour made according to an Etruscan tradition. It's a high-quality arched plate cuirass sewn with dyed leather and fitted with a wide skirt at the bottom to cover the groin."
	icon_state = "brigandine"
...
/obj/item/clothing/suit/roguetown/armor/brigandine/sheriff/Initialize()
	. = ..()
	if(GLOB.townprimary)
		towncolor(GLOB.townprimary,GLOB.townsecondary)
	GLOB.towncolor += src

/obj/item/clothing/suit/roguetown/armor/brigandine/sheriff/towncolor(primary,secondary)
	detail_tag = "_det"
	detail_color = primary
	update_icon()
	if(ismob(loc))
