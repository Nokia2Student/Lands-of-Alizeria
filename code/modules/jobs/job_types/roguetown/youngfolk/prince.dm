/datum/job/roguetown/prince
	...
	tutorial = "Ты - сын или дочь наместника земель Ализерии. Твоё детство прошло в богатстве и комфорте, а также у тебя было куча времени и возможностей получить то образование, которое непозволительно смердам. Воспользовался ли ты этими возможностями или нет - зависит исключительно от тебя."
	...
	allowed_patrons = CODEX		//Same reason as lord. See Lord.
...
/datum/outfit/job/heir/daring/pre_equip(mob/living/carbon/human/H)
	...
	if(equipment_choice == "Wartime Outfit")
		...
		wrists = /obj/item/storage/keyring/alizeria/prince
	else
