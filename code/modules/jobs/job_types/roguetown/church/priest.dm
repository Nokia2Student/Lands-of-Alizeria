...
/datum/job/roguetown/priest
	...
	f_title = "Priestess"
	allowed_races = ALIZ_NOBLE_RACES // for some stupid reason we gate this by "too recent arrivals", how about fuck you: i cast doll/golem priest
	...
	tutorial = "Вопреки мнению незнающих - кодекс основан на старых писаниях пантеона десяти. Будучи жрецом - тебе предстоит находить компромисс во мнениях староверов и кодексинцев, а также стараться удержать порядок на всём острове. Не дай пролиться крови из-за жалких людей, что хотят власти, ибо настоящая власть - удел богов, а не смертных."
	whitelist_req = FALSE
...
/datum/outfit/job/priest/basic/pre_equip(mob/living/carbon/human/H)
	...
	armor = /obj/item/clothing/suit/roguetown/shirt/dress/alizeria/priarmor
	backl = /obj/item/storage/backpack/rogue/satchel
	gloves = /obj/item/clothing/gloves/roguetown/alizeria/noblegloves/alt
...
/mob/living/carbon/human/proc/churchannouncement()
	...
	if(stat)
		return
	if(!(devotion && devotion.devotion >= 0))
		to_chat(src, span_warning("I need more devotion to channel Her voice! (0 required)"))
		return FALSE
