/datum/job/roguetown/monk
	...
	tutorial = "Церковь Кодекса зачастую занимается урегулированием общественных разногласий, а также изучением различных артефактов эпохи существования Империи. Будучи аколитом - тебе предстоит проводить изучения и составлять писания, что бы понять ошибки Империи."
