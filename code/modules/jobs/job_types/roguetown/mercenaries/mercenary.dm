/datum/job/roguetown/mercenary
	...
	tutorial = "Псы войны и те, кто просто готов выполнить грязную работу. В отличие от простых приключенцев - ты обладаешь большим опытом, а также стараешься найти себе достойную работёнку в пределах городских стен или недалеко от них."
