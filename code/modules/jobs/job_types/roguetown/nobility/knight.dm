...
/datum/outfit/job/knight
	...
	backpack_contents = list(/obj/item/storage/keyring/alizeria/knight = 1)
...
/datum/advclass/knight/champion
	...
	min_pq = 0 // "stick larp knight at 30 or something just so there's less speedclicking competitions among knights that want to powergame"
