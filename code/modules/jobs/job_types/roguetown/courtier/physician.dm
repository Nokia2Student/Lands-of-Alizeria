/datum/job/roguetown/physician
	...
	tutorial = "Ты - лекарь вольного города. Авантюристы постоянно получают различные травмы, а иногда даже умирают за пределами стен города. У тебя есть всё, что бы делать на их несчастье деньги."
	...
	social_rank = SOCIAL_RANK_YEOMAN // "department_flag = NOBLEMEN", and direct servant of the COURT
