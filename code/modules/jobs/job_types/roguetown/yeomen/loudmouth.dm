/datum/job/roguetown/loudmouth
	title = "Loudmouth"
	tutorial = "Ты - главный новостной источник всего острова. Многие попытаются оказать на тебя своё влияние, однако помни - ты независим и твоё мнение неподкупно, если только устроенная тебя сумма не скажет за тебя обратное. Собирай информацию, веди интервью и распространяй слухи. Кто знает, может из-за твоих слов развяжется война?"
	flag = LOUDMOUTH
	...
	min_pq = 0 // Now has actual responsibility and is a key figure in town.
	max_pq = null
...
/datum/outfit/job/loudmouth/basic/pre_equip(mob/living/carbon/human/H)
	...
	beltl = /obj/item/roguekey/alizeria/jour
