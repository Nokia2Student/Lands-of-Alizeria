/datum/job/roguetown/guildmaster
	...
	tutorial = "Ты являешься своеборазной 'главой' всех ремесленников и путешественников. Вольный город на то и вольный, что в разных отраслях главенствуют разные люди. Пока шериф обеспокоен защитой града - ты по большей мере занимаешься его развитием. Когда-то давно вашими общими руками были воздвигнуты все окружающие тебя здания, а затем и стены. Не дай же этому всему рухнуть."
...
/datum/outfit/job/guildmaster/basic/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		beltr = /obj/item/storage/keyring/alizeria/innkeep
