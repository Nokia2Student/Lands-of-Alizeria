/datum/job/roguetown/farmer
	...
	tutorial = "Любая экономика держится на простых рабочих, а простые рабочие держатся на труде низменных крестьян. Умелое управление городских властителей позволили тебе обзавестись собственным домом и полем, готовым к посеву."
