/datum/job/roguetown/warden
	...
	tutorial = "Когда-то давно исследование земель Ализерии было весьма прибыльным делом. Пускай большая часть территорий были изучены почти полностью - роль исследовательских рейнджеров до сих пор остаётся актуальной. Пока твои 'коллеги' занимаются безопасностью на городских улицах - ты занимаешься соблюдением безопасности на загородных тропах. Твоя работа не из самых безопасных, однако риск оплачивается тем, что тебе дозволено присваивать найденные на дорогах трофеи - себе."
...
/datum/outfit/job/warden/ranger/pre_equip(mob/living/carbon/human/H)
	...
	backpack_contents = list(
		/obj/item/storage/keyring/alizeria/townguard = 1,
