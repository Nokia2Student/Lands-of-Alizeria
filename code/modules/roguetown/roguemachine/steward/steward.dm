...
/obj/structure/roguemachine/steward
	...
	var/compact = TRUE
	var/total_deposit = 0
	var/list/excluded_jobs = list("Wretch","Vagabond","Adventurer","Blackguard", "Druidess", "Slave Whore")
...
/obj/structure/roguemachine/steward/proc/setup_default_payments()
	daily_payments["Militia Captain"] = 60 //Garrison
	daily_payments["Militiaman"] = 40
	daily_payments["Town Ranger"] = 20
	daily_payments["Clerk"] = 20
	daily_payments["Archivist"] = 15
	daily_payments["Guildmaster"] = 30
	daily_payments["Loudmouth"] = 20 //Manor-House
	daily_payments["Innkeeper"] = 15
	daily_payments["Tailor"] = 10 //Doctors
	daily_payments["Port Blacksmith"] = 10
	daily_payments["Cook"] = 10 //University
	daily_payments["Daronne"] = 20
	daily_payments["Physician"] = 15
